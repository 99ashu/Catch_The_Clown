...
clownImage = pygame.image.load("assets/clown.png")
...
titleFont = pygame.font.Font("assets/Celosia.otf", 50)
hudFont = pygame.font.Font("assets/Celosia.otf", 40)
...
point = pygame.mixer.Sound("assets/SonicRingg.wav")
point.set_volume(0.7)
miss = pygame.mixer.Sound("assets/Zap.wav")
miss.set_volume(0.2)
pygame.mixer.music.load("assets/clownbgm.wav")
